...
export const supervisorGraph = new StateGraph(SupervisorState)
    ...
    .addNode("sql", async (state) => {
        const result = await runSqlAgent(state.original_user_msg, state.email);
    ...
    .addConditionalEdges("add_to_cart", (s) => {
        // Nếu không có cartProduct thì quay lại match_product
        ...
        // Ngược lại thì theo current_step bình thường
